    ...
    <div class="col-12">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <div class="controls">
                    <input type="text" name="product_tags_hin" class="form-control" value="Lorem,Ipsum,Amet" data-role="tagsinput" placeholder="add tags" required >
            ...
            <div class="form-group col-md-4">
                ...
                <div class="controls">
                    <input type="text" name="product_size_en" class="form-control" value="Small,Medium,Large" data-role="tagsinput" placeholder="add tags" required>
            ...
            <div class="form-group col-md-4">
                ...
                <div class="controls">
                    <input type="text" name="product_size_hin" class="form-control" value="Small,Medium,Large" data-role="tagsinput" placeholder="add tags" required>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <div class="controls">
                    <input type="text" name="product_color_en" class="form-control" value="Red,Black,Amet" data-role="tagsinput" placeholder="add tags" required >
            ...
            <div class="form-group col-md-4">
                ...
                <div class="controls">
                    <input type="text" name="product_color_hin" class="form-control" value="Red,Black,Large" data-role="tagsinput" placeholder="add tags" required >
