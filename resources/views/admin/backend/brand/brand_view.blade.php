                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('brand.delete',$item->id)}}" class="btn btn-danger"  title="Delete" ><i class="fa fa-trash"></i></a>
                                        </td>
                                ...
                                <form method="post" action="{{route('brand.store')}}"  enctype="multipart/form-data">
                                    @csrf
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="brand_name_en" class="form-control"  value=""> <div class="help-block"></div></div>
                                                        @error('brand_name_en')
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="brand_name_hin" class="form-control"  value=""> <div class="help-block"></div></div>
