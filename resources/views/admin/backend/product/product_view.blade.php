                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach($products as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('edit.product',$item->id)}}" class="btn btn-primary" title="Products Details Data"><i class="fa fa-eye"></i></a>
                                                <a href="{{route('edit.product',$item->id)}}" class="btn btn-info" title="Edit"><i class="fa fa-pencil"></i></a>
                                                <a href="{{route('product.delete',$item->id)}}" class="btn btn-danger"  title="Delete" ><i class="fa fa-trash"></i></a>
                                                @if($item->status == 1)
