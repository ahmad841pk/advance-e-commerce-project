                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">Stock:<span class="badge badge-pill bagde-success" id="aviable" style="background:green; color:white"></span>
                                    <span class="badge badge-pill bagde-danger" id="stockout" style="background:red; color:white"></span>
                                </li>
                            </ul>
