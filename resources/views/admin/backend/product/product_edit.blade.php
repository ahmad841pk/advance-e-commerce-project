    ...
    <div class="col-12">
                    ...
                    <div class="controls">
                        <select name="category_id"  class="form-control" required>
                            ...
                            @foreach ($category as $sub )
                                ...
                                <option value="{{$sub->id}}"{{ $sub->id == $products->category_id? 'selected':'' }} >{{ $sub->category_name_en }}</option>
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <select name="subsubcategory_id"  class="form-control" required>
                            ...
                            <option value="{{$sub->id}}"{{ ($subsub->id == $products->subsubcategory_id)? 'selected':'' }} >{{ $subsub->subsubcategory_name_en }}</option>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <div class="controls">
                    <input type="text" name="product_tags_en" class="form-control"  data-role="tagsinput" placeholder="add tags" required value="{{ $products->product_tags_en }}" >
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <div class="controls">
                    <input type="text" name="product_tags_hin" class="form-control"  data-role="tagsinput" placeholder="add tags" required value="{{ $products->product_tags_hin }}" >
            ...
            <div class="form-group col-md-4">
                ...
                <div class="controls">
                    <input type="text" name="product_size_en" class="form-control"  data-role="tagsinput" placeholder="add tags" required value="{{ $products->product_size_en }}">
            ...
            <div class="form-group col-md-4">
                ...
                <div class="controls">
                    <input type="text" name="product_size_hin" class="form-control"  data-role="tagsinput" placeholder="add tags" required value="{{ $products->product_size_hin }}">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <div class="controls">
                    <input type="text" name="product_color_en" class="form-control"  data-role="tagsinput" placeholder="add tags" required value="{{ $products->product_color_en }}">
            ...
            <div class="form-group col-md-6">
                ...
                <div class="controls">
                    <input type="text" name="product_color_hin" class="form-control"  data-role="tagsinput" placeholder="add tags" required value="{{ $products->product_color_hin }}" >
        ...
        <div class="box bt-3 border-info">
          ...
          <div class="col-md-3">
            ...
            <div class="card" style="width: 18rem;">
                <img src="{{ asset($img->photo_name)}}" class="card-img-top" alt="..." style="height:130px; width:280">
                <div class="card-body">
                  <h5 class="card-title">
                    <a href="{{ route('product.multiImg.delete',$img->id) }}" class="btn btn-sm btn-danger" title="Delete">Delete</a>
                </h5>
                  <p class="card-text"></p>
                  <div class="form-group">
...
{{-- End Multi Image Edit --}}


{{-- // Thumbnail Image Edit start --}}
        ...
        <div class="col-md-12">
            <div class="box bt-3 border-info">
              ...
              <div class="col-md-3">
                ...
                <div class="card" style="width: 18rem;">
                    <img src="{{ asset($products->product_thumbnail)}}" class="card-img-top" alt="..." style="height:130px; width:280">
                    <div class="card-body">
